...
function IdentityVerification() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.place_of_birth) submitData.append('place_of_birth', formData.place_of_birth);
    ...
    <div className="px-5 mx-auto max-w-[1366px] py-8">
      ...
      {loading ? (
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-md shadow-md">
          ...
          <div className="mb-6">
            <label htmlFor="document_front" className="block font-semibold text-sm mb-2">
          ...
          <div className="mb-6">
            <label htmlFor="document_back" className="block font-semibold text-sm mb-2">
          ...
          <button
            type="submit"
            disabled={loading || !formData.document_front || !formData.full_name || !formData.document_number || !formData.date_of_birth}
